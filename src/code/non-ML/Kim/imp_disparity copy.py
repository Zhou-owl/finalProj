...
if __name__ == "__main__":
    ...
    if terminal:
        ...
        disney = Disney("./box.hdf5", "box", "results_all/",
                        working_dir='tmp/', n_cpus=-1,
                        r_start=None, s_hat=50, DEBUG=False)

        # disney.calculateDisp(min_disp=0, max_disp=25,
        #                     stepsize=0.5, Ce_t=5, Cd_t=0.1,
        #                     S_t=4, NOISEFREE=True)
        start = time.time()
